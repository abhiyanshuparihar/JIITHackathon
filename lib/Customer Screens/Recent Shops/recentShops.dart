...
import 'package:iiitmprojectbakaya/Customer%20Screens/All%20Credits%20and%20Settlements%20Page/allCreditsAndSettlementPage.dart';
...
class RecentShops extends StatefulWidget {
  const RecentShops({super.key});

  @override
  State<RecentShops> createState() => _RecentShopsState();
}

class _RecentShopsState extends State<RecentShops> with TickerProviderStateMixin {
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: (){
                        Navigator.push(context,MaterialPageRoute(builder: (context)=>AllCreditsPage(settlementRoomId: "${widget.connection.storeUid}_${FirebaseAuth.instance.currentUser!.uid}")));
                      },
                      icon: Icon(
