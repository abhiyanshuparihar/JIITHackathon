...
class WarehousingRegistrationPage extends StatefulWidget {
  @override
  _WarehousingRegistrationPageState createState() => _WarehousingRegistrationPageState();
}

class _WarehousingRegistrationPageState extends State<WarehousingRegistrationPage> with TickerProviderStateMixin {
  ...
  // Cyan gradient for warehousing
  final LinearGradient _warehousingGradient = MyGradients.blueGradient;
  ...
  Future<void> registerWarehouse() async {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                Text(
                  'Warehouse has been registered successfully.',
                  style: TextStyle(
                    fontSize: 16,
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCustomTextField(
              ...
              validator: (val) => val!.isEmpty ? 'Enter warehouse name' : null,
            ),
            SizedBox(height: 16),
            _buildCustomTextField(
              label: 'Phone Number',
