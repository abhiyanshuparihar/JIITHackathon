...
class ManufacturerRegisterPage extends StatefulWidget {
  @override
  _ManufacturerRegisterPageState createState() => _ManufacturerRegisterPageState();
}

class _ManufacturerRegisterPageState extends State<ManufacturerRegisterPage> with TickerProviderStateMixin {
  ...
  Future<void> registerManufacturer() async {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                Text(
                  'Manufacturer has been registered successfully.',
                  style: TextStyle(
                    fontSize: 16,
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCustomTextField(
              ...
              validator: (val) => val!.isEmpty ? 'Enter manufacturer name' : null,
            ),
            SizedBox(height: 16),
            _buildCustomTextField(
              label: 'Phone Number',
