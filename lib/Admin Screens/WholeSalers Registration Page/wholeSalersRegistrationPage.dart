...
class WholeSalersRegistrationPage extends StatefulWidget {
  @override
  _WholeSalersRegistrationPageState createState() => _WholeSalersRegistrationPageState();
}
...
class _WholeSalersRegistrationPageState extends State<WholeSalersRegistrationPage> with TickerProviderStateMixin {
  ...
  Future<void> registerWholesaler() async {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                Text(
                  'Wholesaler has been registered successfully.',
                  style: TextStyle(
                    fontSize: 16,
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCustomTextField(
              ...
              validator: (val) => val!.isEmpty ? 'Enter wholesaler name' : null,
            ),
            SizedBox(height: 16),
            _buildCustomTextField(
              label: 'Phone Number',
